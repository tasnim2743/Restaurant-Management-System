    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                <div class="mb-6">
                    <h2 class="text-2xl font-semibold text-gray-800">Create New Reservation</h2>
                    <p class="mt-1 text-sm text-gray-600">Book a new table reservation</p>
                </div>

                <form action="{{ route('admin.reservations.store') }}" method="POST" class="max-w-2xl">
                    @csrf
                    <div class="space-y-6">
